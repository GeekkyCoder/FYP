...
const sendVerificationEmail = async ({
  ...
  const verifyEmail = `${origin}/user/verify-email?email=${email}`;

  const message = ` <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2>Account Confirmation</h2>
  <p>Dear ${name},</p>
  <p>Thank you for registering with our phone tracker. To activate your account, please click the button below:</p>
